...
from data.utils import dataset_parquets, get_tokenizer

parser = argparse.ArgumentParser(description='Eval a BPE tokenizer')
parser.add_argument('--dataset_name', type=str, default="fineweb", help='Dataset name to train the tokenizer')
args = parser.parse_args()

parquets_iter_batched = dataset_parquets(args.dataset_name)
...
for tokenizer_name in ["gpt2", "gpt4", "ours"]:
    ...
    if tokenizer_name == "gpt2":
        ...
        tokenizer = get_tokenizer(args.dataset_name)
