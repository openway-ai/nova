...
export NOVA_BASE_DIR="$HOME/.cache/nova/mdlm"
...
[ -d "../../.venv/mdlm" ] || uv venv ../../.venv/mdlm
# install the repo dependencies
# CUDA 12.8 is required to build flash-attn against torch cu128
export CUDA_HOME=/apps/pkg/cuda/12.8
export PATH=$CUDA_HOME/bin:$PATH
UV_PROJECT_ENVIRONMENT=../../.venv/mdlm uv sync --extra gpu
