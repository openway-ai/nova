...
### LOG INFO ###
# SBATCH --job-name=ebt-xxs-ctx2048_s1_lr_
# SBATCH --output=logs/slurm/nlp/ebt-xxs-ctx2048_s1_lr_%A-%a.log
# export RUN_NAME="ebt-d26-ctx2048_s1_lr_"
export RUN_NAME="ebt-xxs-ctx2048_s1_lr_"
