...
python -m data.fineweb.dataset -n 8
...
python -m data.fineweb.dataset -n 370 &
DATASET_DOWNLOAD_PID=$!
# train the tokenizer with vocab size 2**15 = 32768 on ~2B characters of data
python -m data.tok_train --dataset_name fineweb
# evaluate the tokenizer (report compression ratio etc.)
python -m data.tok_eval --dataset_name fineweb
