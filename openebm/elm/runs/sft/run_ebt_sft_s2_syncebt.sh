...
export EXP_ID="d26-ctx2048-20260511-s2"
...
PRETRAIN_CKPT="/mnt/shared-storage-user/luyudong/nova/logs/checkpoints/s2-2node-8gpu-bf16mixed-ebtsync_0511_1934_d26_s2_ctx2048_bs512_lr0.00025_2nodes_8gpus/s=step=6999-d26-ctx2048-lr0.00025-bs1x32-muon_adamw-valid_loss=valid_loss=2.7702.ckpt"
...
MCMC_STEP_SIZE_LR_MULTIPLIER=1.0
MCMC_NUM_STEPS=1
EBT_TYPE="time_embed"
