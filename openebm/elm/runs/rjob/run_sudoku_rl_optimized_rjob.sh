...
run_inside_rjob() {
    ...
    export MIN_REWARD_MEAN_TO_UPDATE
    export MIN_REWARD_FORMAT_TO_UPDATE
...
'
    ...
    rjob submit \
      ...
      -e MIN_REWARD_MEAN_TO_UPDATE="${MIN_REWARD_MEAN_TO_UPDATE}" \
      -e MIN_REWARD_FORMAT_TO_UPDATE="${MIN_REWARD_FORMAT_TO_UPDATE}" \
