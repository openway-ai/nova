...
################################################################################
# EBT d26 训练脚本 - Muon+AdamW 混合优化器 - 1节点 × 8卡
#
# 策略:
...
#
# 用法:
#   通过 rjob 提交 (见配套的 rjob_ebt_1node_8gpu.sh)
#   本地调试: NODE_RANK=0 NODE_COUNT=1 MASTER_ADDR=127.0.0.1 PROC_PER_NODE=8 bash run_ebt_1node_8gpu.sh
#
################################################################################
...
### 基础配置 ###
RUN_PREFIX="1node-8gpu-bf16mixed"
